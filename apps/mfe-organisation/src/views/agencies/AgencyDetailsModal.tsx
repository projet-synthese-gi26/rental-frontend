        ...
        <div className="relative w-full max-w-5xl bg-white dark:bg-[#1a1d2d] rounded-[3rem] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden border border-white/10 animate-in zoom-in">
          <div className="px-10 py-8 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-[#0528d6] text-white">
            <div className="flex items-center gap-6">
                ...
                <div>
                    <h3 className="text-3xl font-[900] italic tracking-tighter uppercase leading-none">{data.name}</h3>
                    <p className="text-xs font-bold opacity-70 uppercase tracking-[0.2em] mt-2 italic flex items-center gap-2"><MapPin size={12}/> {data.city}, {data.region}</p>
                </div>
            </div>
          ...
          <div className="p-10 overflow-y-auto custom-scrollbar space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <section className="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800">
                    <h4 className="text-xs font-black uppercase text-[#0528d6] italic mb-8 flex items-center gap-3 border-b pb-4"><Globe size={18}/> Contact & Coordonnées</h4>
                ...
                <section className="bg-slate-50 dark:bg-slate-900/50 p-8 rounded-[2.5rem] border border-slate-100 dark:border-slate-800">
                    <h4 className="text-xs font-black uppercase text-[#0528d6] italic mb-8 flex items-center gap-3 border-b pb-4"><Target size={18}/> Configuration Opérationnelle</h4>
                    <div className="space-y-6">
                        ...
                        <div className="pt-6 flex items-center gap-3 p-4 bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700">
                            ...
                            <p className="text-[10px] font-black uppercase text-slate-800 dark:text-white italic">Réservation en ligne autorisée</p>
                        </div>
                    </div>
                </section>
            </div>
