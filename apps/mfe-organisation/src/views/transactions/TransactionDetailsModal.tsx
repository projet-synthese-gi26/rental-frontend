// FILE: apps/mfe-organisation/src/views/transactions/TransactionDetailsModal.tsx
          ...
          <div className="p-10 overflow-y-auto custom-scrollbar space-y-8">
            ...
            {data.planDetails && (
                <div className="p-6 bg-orange-50 border-2 border-orange-100 dark:bg-orange-900/10 dark:border-orange-900/30 rounded-[2rem]">
                    <h4 className="text-xs font-black uppercase text-orange-600 italic mb-4">Liaison Abonnement</h4>
                    <div className="space-y-2">
