  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard label="Effectif Réseau" value={staffList.length} icon={<Users />} />
        <StatCard label="Postes configurés" value={postes.length} icon={<MapPin className="text-orange-500" />} />
