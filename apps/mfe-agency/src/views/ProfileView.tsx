        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white dark:bg-[#1a1d2d] rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm relative text-left">
            <div className="flex justify-between items-center border-b border-slate-50 dark:border-slate-800 pb-4 mb-6">
              <div className="flex items-center gap-3 text-[#0528d6]">
                <Lock size={20}/>
                <h4 className="text-sm font-bold uppercase italic tracking-tighter text-slate-800 dark:text-white">Mes informations</h4>
              </div>
              {!editProfileMode && (
          ...
          <section className="bg-white dark:bg-[#1a1d2d] rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm relative text-left">
            <div className="flex justify-between items-center border-b border-slate-50 dark:border-slate-800 pb-4 mb-6">
              <div className="flex items-center gap-3 text-[#0528d6]">
                <ShieldCheck size={20}/>
                <h4 className="text-sm font-bold uppercase italic tracking-tighter text-slate-800 dark:text-white">Sécurité du compte</h4>
              </div>
              {!editPasswordMode && (
          ...
          <section className="bg-white dark:bg-[#1a1d2d] rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-sm text-left relative">
            ...
            {editAgencyMode ? (
              <form onSubmit={handleAgencySubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Nom Agence</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Téléphone</label>
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Adresse physique</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest italic">Horaires (ex: 08:00-18:00)</label>
